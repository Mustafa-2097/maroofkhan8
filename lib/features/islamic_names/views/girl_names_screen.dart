...
class GirlNamesScreen extends StatelessWidget {
  const GirlNamesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final girlNames = controller.girlNames;
                ...
                children: [
                  Expanded(
                    child: Container(
                      ...
                      child: TextField(
                        onChanged: (val) =>
                            controller.girlSearchQuery.value = val,
